...
from .converter import convert_pony_field, MongoEngineConversionError
from .registry import get_global_registry
from .utils import get_model_reference_fields, get_node_from_global_id


class PonyConnectionField(ConnectionField):
    def __init__(self, type, *args, **kwargs):
        ...
        super(PonyConnectionField, self).__init__(type, *args, **kwargs)
    ...
    def reference_args(self):
        def get_reference_field(r, kv):
            ...
            if isinstance(
                ...
                field = convert_pony_field(mongo_field, self.registry)
